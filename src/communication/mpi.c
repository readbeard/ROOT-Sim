...
static void stats_reduction_init(void)
{
	...
	static_assert(offsetof(struct stat_t, max_resident_set) == (sizeof(double) * 36), "The packing assumptions on struct stat_t are wrong or its definition has been modified");
